    ...
    <div className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <nav className="fixed top-0 w-full bg-stone-50/90 backdrop-blur-sm border-b border-stone-200 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          <span className="font-medium text-earth-700 text-sm sm:text-base">Hadassah Roberts</span>
      ...
      {/* Hero Section */}
      <header className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12 text-center md:text-left">
          <div className="flex-1">
            <p className="text-earth-600 mb-2 tracking-wide text-xs sm:text-sm uppercase">Developer</p>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-light text-stone-900 mb-4 sm:mb-6 leading-tight">
              Hadassah Roberts
            </h1>
            <p className="text-base sm:text-xl text-stone-600 max-w-2xl leading-relaxed mx-auto md:mx-0">
          ...
          <div className="flex-shrink-0">
            <img
              ...
              className="w-36 h-36 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-full object-cover border-4 border-earth-200 shadow-lg"
            />
          </div>
        </div>
      </header>
      ...
      {/* About Section */}
      <section id="about" className="py-12 sm:py-20 px-4 sm:px-6 bg-white border-y border-stone-200">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-sm uppercase tracking-wide text-earth-600 mb-6 sm:mb-8">About</h2>
      ...
      <section id="projects" className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-sm uppercase tracking-wide text-earth-600 mb-8 sm:mb-12">Projects</h2>

          {/* Project 1 */}
          <article className="mb-12 sm:mb-16 pb-12 sm:pb-16 border-b border-stone-200">
            <div className="grid md:grid-cols-5 gap-6 md:gap-8">
              <div className="md:col-span-3 order-2 md:order-1">
                <h3 className="text-xl sm:text-2xl font-medium text-stone-900 mb-2">Alchemy Brew</h3>
              ...
              <div className="md:col-span-2 order-1 md:order-2">
                <img
                  ...
                  className="w-full aspect-video object-cover object-top border border-stone-200 rounded-sm"
                />
              </div>
            </div>
            <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-earth-50 border-l-2 border-earth-400">
          ...
          <article>
            <div className="grid md:grid-cols-5 gap-6 md:gap-8">
              <div className="md:col-span-3 order-2 md:order-1">
                <h3 className="text-xl sm:text-2xl font-medium text-stone-900 mb-2">MicroHabit</h3>
                <p className="text-stone-600 mb-4 leading-relaxed">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 sm:py-20 px-4 sm:px-6 bg-stone-900 text-stone-100">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-sm uppercase tracking-wide text-earth-400 mb-4">Get in Touch</h2>
          <p className="text-xl sm:text-2xl font-light mb-6 sm:mb-8">
            Interested in working together?
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-6">
            <a
              href="mailto:hadassahplaysflute@gmail.com"
              className="w-full sm:w-auto px-6 py-3 bg-earth-600 hover:bg-earth-700 text-white transition-colors text-center"
            >
              Email Me
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto px-6 py-3 border border-stone-600 hover:border-stone-400 transition-colors text-center"
            >
              LinkedIn
            </a>
            <a
